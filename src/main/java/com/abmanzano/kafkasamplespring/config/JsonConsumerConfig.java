...
public class JsonConsumerConfig {
    ...
    @Bean
    public ConsumerFactory<String, Order> jsonSerConsumerFactory() {
        Map<String, Object> props = new HashMap<>();
        props.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, Constants.KAFKA_IP_PORT);
        props.put(ConsumerConfig.GROUP_ID_CONFIG, Constants.JSON_CONSUMER_GROUP_ID);
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, Order> kafkaJsonListenerContainerFactory() {
        ConcurrentKafkaListenerContainerFactory<String, Order> factory =
                new ConcurrentKafkaListenerContainerFactory<>();
        factory.setConsumerFactory(jsonSerConsumerFactory());
