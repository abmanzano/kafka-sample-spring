...
public class StringProducerConfig {
    ...
    @Bean
    public ProducerFactory<String, String> strSerProducerFactory() {
    ...
    @Bean
    public KafkaTemplate<String, String> strSerKafkaTemplate() {
        return new KafkaTemplate<>(strSerProducerFactory());
    }
}
