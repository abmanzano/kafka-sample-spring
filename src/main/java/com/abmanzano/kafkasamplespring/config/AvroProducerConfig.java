...
import com.abmanzano.kafkasamplespring.serdes.AvroSerializer;
...
public class AvroProducerConfig {
    ...
    @Bean
    public ProducerFactory<String, Order> avroSerProducerFactory() {
    ...
    @Bean
    public KafkaTemplate<String, Order> avroSerKafkaTemplate() {
        return new KafkaTemplate<>(avroSerProducerFactory());
    }
}
