...
public class JsonProducerConfig {
    ...
    @Bean
    public ProducerFactory<String, Order> jsonSerProducerFactory() {
    ...
    @Bean
    public KafkaTemplate<String, Order> jsonSerKafkaTemplate() {
        return new KafkaTemplate<>(jsonSerProducerFactory());
    }
}
